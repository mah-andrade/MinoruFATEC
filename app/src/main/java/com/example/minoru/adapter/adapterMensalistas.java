...
public class adapterMensalistas extends FirestoreRecyclerAdapter<veiculos, adapterMensalistas.vecHolder> {
    private OnItemClickListener listener;
    private int aux;
    public adapterMensalistas(@NonNull FirestoreRecyclerOptions<veiculos> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull vecHolder holder, int position, @NonNull veiculos model) {
        ...
        holder.text_hora.setText(model.getVencimentoContrato());
        holder.txthorario.setText("Vencimento");
