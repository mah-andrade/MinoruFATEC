...
import com.example.minoru.models.Vagaqtd;
...
public class Fragment1 extends Fragment {
    ...
    private CollectionReference vec;
    private adapterVeiculo adapter;
    private String id;
    private View groupFragmentView;
    private Dialog dialogResumo, dialogFinal;

    private String clienteFinal,veiculoFinal;
    private String timeFinal;
    private double valorDiario_c, valorAvulso_c;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        groupFragmentView = inflater.inflate(R.layout.fragment_1, container, false);
        iniciar_recycler();
    ...
    private void iniciar_recycler(){
        ...
        vec = db.collection("Veiculo").document("DIAS")
                .collection(dateCapter()).document("MOVIMENTACAO").collection("Avulso");


        Query query = vec.orderBy("nome",Query.Direction.ASCENDING);
        ...
        RecyclerView recyclerView = groupFragmentView.findViewById(R.id.recy_vec);
    ...
    private void frontDialog(Dialog dialog) {
        ...
        DocumentReference recuperarDados = db.collection("Veiculo").document("DIAS")
                .collection(dateCapter()).document("MOVIMENTACAO").collection("Avulso").document(id);
            ...
            public void onClick(View view) {
                ...
                docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        String[] auxHorae = hora.split(":");
                        String[] auxHoraS = hs.split(":");

                        int tMinini = calcularValor(auxHorae[0], auxHorae[1]);
                        int tMinFin = calcularValor(auxHoraS[0],auxHoraS[1]);
                        int resMin = tMinFin - tMinini;
                        dadosF.put("tempoMinutos",resMin);
